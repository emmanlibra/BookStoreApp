...
/**
 * Servlet implementation class LoadBookDataServlet
 */
@WebServlet("/LoadBookDataServlet")
public class LoadBookDataServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public LoadBookDataServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String bookId = request.getParameter("bookIdNo");
		BookServiceDao dao =  new BookServiceDao();
		Book book = dao.getSpecificBook(bookId);
